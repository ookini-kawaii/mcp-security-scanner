...
- 运行时监控：通过 stdio 启动 MCP Server，按声明能力轮询 `tools/list`、`resources/list`、`resources/templates/list` 和 `prompts/list`，检测对象增删及安全相关元数据变化。
- 协议兼容：显式支持 `2024-11-05`、`2025-03-26`、`2025-06-18` 和 `2025-11-25` 传统初始化握手；未知版本 fail-closed。
